...
- Each element of array A is an integer with the range [-10,000..10,000]

- There is at least one element in array A which satisfies the condition in the task statement.

In your solution, focus on correctness. The performance of solution will not be the focus of the assessment.